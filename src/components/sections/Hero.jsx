        ...
        >
          <div className="order-2 lg:order-1">
            <motion.div variants={itemVariants} className="mb-4">
              <span className="px-4 py-2 rounded-full glass text-primary-400 text-sm font-medium">
                Available for work
              </span>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap gap-4 mb-8">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-primary-600 to-primary-500 text-white font-medium flex items-center gap-2 btn-shine glow-blue"
              >
            ...
            <motion.div variants={itemVariants} className="flex gap-4">
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="p-3 rounded-xl glass text-gray-400 hover:text-primary-400 hover:bg-primary-500/10 transition-all"
          ...
          >
            <div className="relative" style={{ perspective: '1000px' }}>
              ...
              <motion.div
                className="relative w-72 h-80 md:w-80 md:h-96 rounded-3xl overflow-hidden glass glow-blue"
                whileHover={{ 
                  scale: 1.03,
                  y: -8,
                }}
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-dark-800 to-dark-700 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-40 h-40 mx-auto mb-4 rounded-full bg-gradient-to-br from-primary-500 to-purple-600 p-1">
                    ...
                    <p className="text-gray-400 text-sm">Marc Kian I. Hugue</p>
                    <p className="text-primary-400 text-xs mt-2">Developer & IoT Enthusiast</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 glass">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-white font-semibold">First Year Student</p>
                      <p className="text-primary-400 text-xs">Full Stack Developer</p>
                    </div>
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 px-3 py-2 rounded-xl glass bg-primary-500/20"
              >
                <span className="text-primary-400 text-sm font-medium">React.js</span>
              </motion.div>

              <motion.div
                animate={{ y: [0, 10, 0] }}
                transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }}
                className="absolute -bottom-4 -left-4 px-3 py-2 rounded-xl glass bg-purple-500/20"
              >
                <span className="text-purple-400 text-sm font-medium">IoT Expert</span>
              </motion.div>
            </div>
          </motion.div>
        </motion.div>
